...
const Card = (props) => {
    const { id, job, company, industry, location, remoteType, minExp, maxExp, minSal, maxSal, employees, isQuickApply } = props
    ...
    const editData = () => {
        setStep1({ job, company, industry, location, remoteType });
        setStep2({ minExp, maxExp, minSal, maxSal, totalEmp: employees, applyType: isQuickApply ? "quickApply" : "externalApply" });
        setEditModal(true);
    }
    ...
    return (
        <div className='bg-card border border-border rounded-lg font-poppins px-6 py-4 text-dark relative'>
            <div className='flex gap-2'>
                ...
                <div>
                    <div className='font-normal mb-6'>
                        <h2 className='text-dark text-2xl'>{job}</h2>
                    ...
                    <div className='font-normal mb-6'>
                        ...
                        {minSal && maxSal && <p className='text-base mb-2'>INR (₹) {minSal?.toLocaleString()} - {maxSal?.toLocaleString()} / Month</p>}
            ...
            <div className="absolute top-0 right-0 m-4">
                <button className="bg-primary text-white p-2 rounded-full" title='edit job' onClick={editData}>
            ...
            {/* Edit Form */}
            {
                ...
                <Modal isOpen={editModal} setIsOpen={setEditModal}>
                    <JobForm step1={step1} step2={step2} isEdit={true} id={id} setModal={setEditModal} />
                </Modal>
            }
            {/* Delete Form  */}
            {
